...
const ChatCard = ({chat, handleFunction}) => {
  ...
  return (
    <li onClick={() => handleFunction(chat.user?._id, chat.supplier?._id)} class="flex flex-no-wrap items-center pr-3 text-black rounded-lg cursor-pointer mt-200 py-65 hover:bg-gray-200" >
        ...
        <div class="flex justify-between w-full">
            ...
            <div class="items-center flex-1 min-w-0">
                <div class="flex justify-between mb-1">
                    <h2 class="text-sm font-semibold text-black">{chat.chatters}{getSender(user, chat.chatters)}</h2>
                    {/* <div class="flex">
                        ...
                        <svg class="w-4 h-4 fill-current" xmlns="http://www.w3.org/2000/svg" width="19" height="14" viewBox="0 0 19 14" >
