...
const  TopChartCard = () => (
    <div className="w-full flex flex-row items-center hover:bg-[#5f7c9c] py-2 p-4 rounded-lg cursor-pointer mb-2">
...
<div className="flex-1 flex flex-col justify-center mx-3 ">
    <Link to={'/supplier'}>
        <p className="text-xl font-bold text-gray-800">supplierName</p>
    </Link>
    <Link to={'/supplier'}>
        ...
        <div ref={divRef} className="xl:ml-6 ml-0 xl:mb-0 mb-6 flex-1 xl:max-w-[500px] max-w-full flex flex-col">
            <div className="w-full flex flex-col">
                <div className="flex flex-row justify-between items-center">
                    <h2 className="text-black fond-bold text-2xl">Top Supplers</h2>
                    <Link to={'/suppliers'}>
            ...
            <div className="w-full flex flex-col mt-8">
                <div className="flex flex-row justify-between items-center">
                    <h2 className="text-black fond-bold text-2xl">Top Chefs</h2>
                    <Link to={'/chefs'}>
