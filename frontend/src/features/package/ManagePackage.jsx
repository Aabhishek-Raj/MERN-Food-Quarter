...
const ManagePackage = () => {
  ...
  const personTotal = async () => {
    await dispatch(pricePerPerson({personCount, id}))
  }
    ...
    <div class="h-screen bg-gray-100 pt-20">
      ...
      <div class="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0">
        ...
        <div class="mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3">
          ...
          <div>
            <input onChange={handlePeopleCount} className='border p-3' type="text" placeholder='No of People...' />
          </div>
          <Link to={`/dash/checkout/${id}`}>
